...
class profit:
    def __init__(self,num):
        ...
        self.S_DIR = os.path.join(S_DIR,self.date + "_ALL")
                ...
                for ii in range(2, 100, 10):
                    ...
                    for iii in range(2, 100, 10):
                        ...
                        for iiii in range(2, 100, 10):
                            ...
                            if PL.iloc[-1]['Sum'] != 0:
                                PL.to_csv(os.path.join(self.S_DIR, code + title + '_breakout_daily_dital.csv'))
#                                y.pl.cumsum().plot()
#                                plt.show()
                            if Equity != 0:
...
#                multi=2.5
            ...
            for ii in range(1,5,1):
                ...
                title = code + "_" + str(i)  + "_" + str(ii) + '_1BacktestReport_dital.csv'
                info.BacktestReport(PL,title)

        print("2")
        for i in range(2,101,10):
            window0=i
            for ii in range(2,101,10):
                window9 = ii
                if i == ii:
                    continue
        ...
        for i in range(2,101,10):
            ...
            for ii in range(2,101,10):
                window9 = ii
                for iii in range(2,101,10):
                    f0 = iii
                    for iiii in range(2,101,10):
                        f9 = iiii
                        if i == ii or iii == iiii:
                            continue
                        title = code + "_" + str(i) + "_" + str(ii) + "_" + str(iii) + \
                            "_" + str(iiii) + '_3breakout_simple_f_dital.csv'
        ...
        for i in range(2,101,10):
            ...
            for ii in range(2,101,10):
                ...
                if i == ii:
                    continue
                title = code + "_" + str(i) + "_" + str(ii) + '_4breakout_ma_two.csv'
            ...
            for ii in range(2,101,10):
                ...
                for iii in range(2,101,10):
                    ...
                    if i > ii > iii or i < ii < iii:
                        title = code + "_" + str(i) + "_" + str(ii) + "_" + str(iii) + '_5breakout_ma_three.csv'
                        PL=info.breakout_ma_three(tsd,window0,window5,window9,col,0)
                        info.BacktestReport(PL,title)
        print(datetime.datetime.now()-t,code)
